...
#Region "ｲﾍﾞﾝﾄ"
        ...
        ''' <summary>ﾗｼﾞｵﾎﾞﾀﾝ上でのｶｰｿﾙｷｰ入力を有効にする</summary>
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        Private Sub cRBtn__PreviewKeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PreviewKeyDownEventArgs) Handles MyBase.PreviewKeyDown
